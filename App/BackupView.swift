...
struct BackupView: View {
    ...
    private func savePreferences(to root: URL) throws {
        ...
        let values = ["app.tintRGB", "reader.fontSize", "reader.lineSpacing", "reader.paper", "reader.pageMode", "reader.typography", "shelf.sort", "speech.preferences", "speech.cloud", "stats.widgets"].reduce(into: [String: Any]()) { if let value = defaults.object(forKey: $1) { $0[$1] = value } }
